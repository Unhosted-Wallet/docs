...
const config = {
  title: 'Unhosted',
  tagline: 'One-Click Automation Wallet',
    ...
    [
      ...
      ({
        ...
        docs: {
          ...
          editUrl:
            'https://github.com/Unhosted-Wallet/docs',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        title: 'Unhosted Wallet',
        logo: {
          alt: 'Unhosted Wallet Logo',
          src: 'img/logo.png',
        },
        items: [
          {
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Telegram',
                href: 'https://t.me/unhostedwallet',
              },
              {
                label: 'Discord',
                href: 'https://discord.gg/5eAMPefqPr',
              },
              {
                label: 'X',
                href: 'https://x.com/unh0sted',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Unhosted Docs Built with Docusaurus.`,
      },
      prism: {
